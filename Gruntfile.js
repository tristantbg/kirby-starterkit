module.exports = function(grunt) {
    grunt.initConfig({
        concat: {
            plugins: {
                src: ['site/plugins/oembed/assets/js/embed.js','lib/history.js/scripts/bundled/html4+html5/jquery.history.js'],
        ...
        cssmin: {
          ...
          target: {
            files: {
              'assets/css/build/build.min.css': ['lib/normalize-css/normalize.css', 'site/plugins/oembed/assets/css/embed.css', 'assets/css/app.min.css']
            }
          }
        },
        watch: {
